...
const MarketingPage: React.FC<MarketingPageProps> = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div className="flex mb-4 items-center border shadow-sm p-4 bg-amber-100 text-amber-700 uppercase rounded-full">
        ...
        <div className="text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white px-4 py-2 md:py-3 rounded-md w-fit">
          work forward
        </div>
      </div>
      <div
