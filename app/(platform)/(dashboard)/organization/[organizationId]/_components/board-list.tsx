      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {boards.map((board) => (
          <Link
            href={`/board/${board.id}`}
            key={board.id}
            className="group relative aspect-video h-full w-full bg-cover bg-sky-700 rounded-sm p-2 bg-no-repeat bg-center overflow-hidden"
...
BoardList.Skeleton = function PopoverSkeleton() {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
